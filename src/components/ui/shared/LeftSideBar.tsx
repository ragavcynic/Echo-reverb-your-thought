    ...
    <nav className='leftsidebar'>
      ...
      <div className='flex flex-col gap-11'>
        <Link to="/" className='flex gap-2 items-center'>
          <img src="/assets/images/echo.png" alt="logo" width={200} height={36} />
        </Link>
        <Link to={`/profile/${user.id}`} className='flex gap-3 items-center'>
          <img className='h-14 w-14 rounded-full' src={user.imageUrl || "/assets/icons/profile-placeholder.svg"} alt="profile" />
